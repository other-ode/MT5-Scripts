...
color TransparentColor(color baseColor, uchar alpha) {
         ...
         if(ObjectFind(0,name)==-1)
           {
            ...
            ObjectSetInteger(0,name,OBJPROP_COLOR,TransparentColor(BullishColor, Transparency));
         ...
         if(ObjectFind(0,name)==-1)
           {
            ...
            ObjectSetInteger(0,name,OBJPROP_COLOR,TransparentColor(BearishColor, Transparency));
            ObjectSetInteger(0,name,OBJPROP_BACK,true);
            ObjectSetInteger(0,name,OBJPROP_FILL,true);
            ObjectSetInteger(0,name,OBJPROP_STYLE,STYLE_SOLID);
            ObjectSetInteger(0,name,OBJPROP_WIDTH,1);
